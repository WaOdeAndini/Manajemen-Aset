...
export default async function DashboardLayout({
  ...
  // Pengaman tambahan di samping middleware — kalau session tidak valid,
  // jangan render apa pun dari dashboard.
  if (!user) {
    redirect("/login");
  }
  ...
  // Area ini khusus admin — staf diarahkan ke portal staf.
  if (profile?.role === "staf") {
    redirect("/staf/pengajuan");
  }
  ...
  const currentUser: CurrentUser = {
    ...
    initials: buatInisial(fullName) || "U",
  };
